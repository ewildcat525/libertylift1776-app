...
export default function Home() {
  ...
  if (postContest) {
    ...
    if (!user) {
      return (
        <main className="guest-offseason-page">
          {accountDeleted && (
          ...
          <Link href="/login" className="guest-offseason-signin">
            Sign in
          </Link>

          <section className="guest-offseason-card" aria-labelledby="guest-offseason-title">
            <div className="guest-offseason-brand" aria-label="Liberty Lift 1776">
              <span className="guest-offseason-crest" aria-hidden="true">
                <i>★</i>
                <b>LL</b>
              </span>
              <span className="guest-offseason-wordmark">
                <strong>Liberty Lift</strong>
                <small><i /> 1776 <i /></small>
              </span>
            </div>

            <div className="guest-offseason-intro">
              <p className="guest-offseason-eyebrow">The challenge returns July 2027</p>
              <h1 id="guest-offseason-title">
                One month.<br />
                1,776 push-ups.<br />
                That&apos;s it.
              </h1>
              <p>A simple challenge. Built for consistency.</p>
            </div>

            <div className="guest-goal" aria-label="Your goal: 1,776 push-ups in 31 days">
              <div className="guest-goal-ring" aria-hidden="true" />
              <div className="guest-goal-copy">
                <span>Your goal</span>
                <strong>1,776</strong>
                <span>Push-ups</span>
                <i />
            ...
            <div id="next-year" className="guest-offseason-conversion">
              {nextYearDone ? (
                <div className="guest-offseason-success" role="status">
                  <span aria-hidden="true">✓</span>
                  <div>
                    <strong>You&apos;re on the 2027 list.</strong>
                    <small>We&apos;ll let you know when registration opens.</small>
                  </div>
                </div>
              ) : (
                <form onSubmit={joinNextYear} className="guest-offseason-form">
                  <label className="sr-only" htmlFor="guest-offseason-email">
                    Email address
                  </label>
                  <div className="guest-offseason-email">
                    <span aria-hidden="true">✉</span>
                    <input
                      id="guest-offseason-email"
                      type="email"
                      inputMode="email"
                      autoComplete="email"
                      autoCapitalize="none"
                  ...
                  <button type="submit" disabled={nextYearBusy}>
                    {nextYearBusy ? 'Joining…' : 'Join the 2027 interest list'}
                  </button>
              ...
              <Link
                href="/finale"
                className="guest-offseason-learn"
                onClick={() => trackCta('offseason_hall')}
              >
                See what we did in 2026 <span aria-hidden="true">→</span>
              </Link>
            </div>
          </section>

          <div className="guest-offseason-result" aria-label="2026 final result">
            <strong>{total}</strong>
            <span>push-ups completed together in 2026</span>
          </div>

          <footer className="guest-offseason-footer">
